...
Frame.Position = UDim2.new(0.717235923, 0, 0.343209863, 0)
...
local function FVCH_fake_script() -- Frame.GUIdrag 
...
coroutine.wrap(FVCH_fake_script)()
local function ZHXFT_fake_script()
...
coroutine.wrap(ZHXFT_fake_script)()
